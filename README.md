...
2. Add TestContainers for easy Postgres usage `dotnet add package Testcontainers.PostgreSql` (or just use a normal db)
...
// spins up a Postgres container for Task Tower (you can also skip this and use a normal db)
